...
export const Card = (items: items) => {
    return (
        <div className={`flex-1 rounded-xl p-2 flex flex-col flex-wrap  justify-between gap-3 overflow-hidden max-md:w-[calc(50%-8px)] max-md:flex-initial max-sm:w-full `} style={{ backgroundColor: items.bgColor }}>
